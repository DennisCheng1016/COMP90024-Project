...
class RelevanceGrader:
    ...
    def grade(self, sentences):
        ...
        res = cls.grade([    "I bet Lakers win.",    "The food at this restaurant is amazing.",    "I'm not a fan of gambling.",    "I'm craving some Chinese food.",    "I always enjoy trying new restaurants.",    "Gambling is a dangerous addiction.",    "This restaurant has great reviews on Yelp.",    "I'm trying to cut down on my gambling habits.",    "I prefer home-cooked meals over eating out.",    "I've never been to a casino before."])
        `
